...
/**
 * Object that extends {@link java.util.ArrayList} and adds the ability to directly get the pool array as a simple array.
 *
 * @version 1.0
 * @since v0.4.0
...
public abstract class Pool<E> extends ArrayList<E> {
	...
	/**
	 * Creates a new Pool object with all the pollObjects added in the parameter {@code poolObjects}.
	 *
	 * @param poolObjects Array of generics that will be treated as the initial list.
	 * @since v0.4.0
	 */
