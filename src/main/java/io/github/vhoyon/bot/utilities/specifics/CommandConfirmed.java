package io.github.vhoyon.bot.utilities.specifics;
 ...
 * how cancellations and pre-confirmations are handled.
 * 
 * @version 1.0
 * @since v0.4.0
...
public abstract class CommandConfirmed extends AbstractCommandConfirmed
	...
	/**
	 * Creates a bare CommandConfirmed to allow for greater flexibility in
	 * determining when to ask for confirmation.
	 * 
	 * <p>
	...
	/**
	 * Creates a CommandConfirmed for the command passed in parameter. This will
	 * immediately trigger the action of the confirmation and wait for a call on
	 * this object's {@link #confirmed()} before actually doing the action of
	 * the command passed in parameter.
	 * <p>
	 * In the case were a call on this object's {@link #cancelled()} is made, a
	 * message in the context of the command passed in the parameter will be
	 * sent that the confirmation was cancelled.
	 * </p>
	 * 
	 * @param commandToConfirm
	 *            The command to require a confirmation before its execution
	 * 
	 * @since v0.4.0
	 */
